<?php
// vote1_checkout.php — Redirection sécurisée vers MaishaPay / CyberSource pour carte
// FIX: Cancel Order sur https://secureacceptance.cybersource.com allait vers https://www.arakapay.com/ au lieu de vote1.php
// Solution: page intermédiaire sans auto-redirect + polling vers vote1_api.php + bouton Annuler qui marque echoue + retour vote1.php
// + ouvre paiement dans nouvel onglet depuis vote1.php pour garder onglet principal ouvert
...
<div class="card">
  ...
  <p class="small">⚠️ Si vous cliquez "Cancel Order" sur <b>secureacceptance.cybersource.com</b>, vous atterrirez sur <b>arakapay.com</b> (config CyberSource drc_proxypay). Revenez sur cet onglet et cliquez "Annuler et retourner" pour revenir dans vote1.php avec la vraie raison (solde insuffisant etc).</p>
  <div class="actions">
