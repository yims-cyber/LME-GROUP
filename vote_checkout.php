<?php
// vote_checkout.php — Redirection sécurisée vers MaishaPay Checkout pour carte
...
try{
    ...
    $vote1Base = $scheme.'://'.$host.'/vote.php?candidat='.(int)$tx['participante_id'].'&concours_id='.(int)$tx['concours_id'].'&etape_id='.($tx['etape_id']? (int)$tx['etape_id']:'').'&receipt='.urlencode($ref);
